...
public class WriteExcel {
    ...
    public static void main(String[] args) {
    	cleanExcelFile("E:/writeExcel.xlsx");
    ...
    public static void cleanExcelFile(String finalXlsxPath){
        try {
...
//           }
            ...
            for (int j = 0; j < dataList.size(); j++) {
                ...
                String address = dataMap.get("idcard").toString();
                String phone = dataMap.get("mobile") == null ? null : dataMap.get("mobile").toString();
                String message = dataMap.get("message").toString();
